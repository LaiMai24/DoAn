...
namespace TECH.Service
{
    public interface ICategoryService
    {
        ...
        List<CategoryModelView> GetAllLevel1();
        int AddPrent(CategoryModelView view);
        bool UpdateParent(CategoryModelView view);
    }
    ...
    public class CategoryService : ICategoryService
    {
        ...
        public List<CategoryModelView> GetAllLevel1()
        {
            var data = _categoryRepository.FindAll(c => c.parentId == null).Select(c => new CategoryModelView()
            {
                id = c.id,
                name = c.name,
                icon = c.icon
        ...
        public int AddPrent(CategoryModelView view)
        {
            try
            {
                if (view != null)
        ...
        public bool UpdateParent(CategoryModelView view)
        {
            try
            {
                var dataServer = _categoryRepository.FindById(view.id);
