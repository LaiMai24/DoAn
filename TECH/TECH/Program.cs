...
app.UseEndpoints(endpoints =>
{
    ...
    endpoints.MapControllerRoute(
     name: "DanhSachSanPhamStatus",
     pattern: "/sach-noi-bat/{*status}",
     defaults: new { controller = "Product", action = "ProductStatus" });

    endpoints.MapControllerRoute(
     name: "DanhSachSanPhamStatus1",
     pattern: "/sach-moi-nhat/{*status}",
     defaults: new { controller = "Product", action = "ProductStatus" });
    ...
    name: "DonHang",
    pattern: "/don-hang",
    defaults: new { controller = "Carts", action = "OrderProgress" });
...
defaults: new { controller = "Users", action = "Accuracy" });
    ...
    endpoints.MapControllerRoute(
name: "MoiNhat",
pattern: "/moi-nhat/{*sort}",
defaults: new { controller = "Product", action = "ProductNew" });
    endpoints.MapControllerRoute(
name: "NoiBat",
pattern: "/noi-bat/{*sort}",
defaults: new { controller = "Product", action = "ProductHight" });
